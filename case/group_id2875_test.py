...
class Test2875(object):
    ...
    def setup_class(self):
        request_obj = Send2Reques('/Users/xiongting/Desktop/工作/DRCC/DRCCTEST/testdata/assetgroups/group_id2875_test.yaml')
        request_obj.ini_case
    
            
    @allure.story('成功删除资产组接口')
    @pytest.mark.smoking
    @call_case('/Users/xiongting/Desktop/工作/DRCC/DRCCTEST/testdata/assetgroups/group_id2875_test.yaml',config.assert_db)
