...
class Test2817(object):
    ...
    def setup_class(self):
        request_obj = Send2Reques('/Users/xiongting/Desktop/工作/DRCC/DRCCTEST/testdata/assetdb/db2817_test.yaml')
    ...
    @pytest.mark.smoking
    @call_case('/Users/xiongting/Desktop/工作/DRCC/DRCCTEST/testdata/assetdb/db2817_test.yaml',config.assert_db)
